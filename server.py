...
try:
    ...
    server_address = ('0.0.0.0', 32444) # diganti ke 32444 sesuai soal
    ...
    while True:
        ...
        file = open('contoh.txt', 'wb')
        logging.info(f"receiving file")
        while True:
            # data = connection.recv(32)
            data = connection.recv(1024) # agar bisa menerima file
